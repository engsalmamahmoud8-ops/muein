-- Extend the admin_list_providers RPC to also expose auth.users.banned_until,
-- so the admin UI can show an "active / inactive" badge and decide whether
-- to render activate vs. deactivate.
